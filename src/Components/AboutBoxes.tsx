    ...
    >
      <div className="flex flex-col space-y-[4vh]">
        <div className="flex space-x-[1.5vw]">
          {/* INTERESTS */}
          <div className="relative w-[36vw] sm:w-[14vw] aspect-[4/4] bg-white text-[#3E2B2B] rounded-[3vw] sm:rounded-[1vw] shadow-md p-[1vw] flex border-[0.4vw] sm:border-[0.23vw] border-[#3E2B2B]">
        ...
        {/* HOBBIES */}
        <div className="relative w-[74vw] sm:w-[29.5vw] aspect-[12/4] bg-white text-[#3E2B2B] rounded-[3vw] sm:rounded-[1vw] shadow-md p-[1.2vw] flex justify-center border-[0.4vw] sm:border-[0.23vw] border-[#3E2B2B]">
          <div className="absolute top-[-1.5vh] sm:top-[-2.5vh] left-[1vw] w-[16vw] sm:w-[7vw] aspect-[9.5/4] bg-[#3E2B2B] rounded-full flex items-center justify-center">
