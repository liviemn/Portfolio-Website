  ...
  return (
    <div className="w-4/5 xl:w-4/5 2xl:w-3/4 h-3/4 bg-white border-4 border-brown rounded-3xl shadow-xl mt-24">
      ...
      >
        ...
        <div className="absolute top-8 left-20 text-7xl xl:text-7x1 2xl:text-10x1 text-white font-pixel">
          My Coding Journey
        </div>
        ...
        <div className="absolute right-20 top-36 text-white font-pixel max-w-[430px] 2xl:max-w-[460px]">
          {selectedBox ? (
