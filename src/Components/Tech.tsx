...
const Tech: React.FC = () => {
  return (
    <div className="absolute left-0 right-0 bg-transparent p-10 max-w-7xl mx-auto mt-28 z-10">
      <div className="flex justify-start items-center gap-12 pl-8 xl:pl-8 2xl:pl-24">
        {/* Left Column */}
